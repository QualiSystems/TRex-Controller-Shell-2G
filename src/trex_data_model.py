...
class TrexControllerShell2G(object):
    def __init__(self, name):
        """ """
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = "TRex Controller Shell 2G"
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :return:
        :rtype TrexControllerShell2G
        """
        result = TrexControllerShell2G(name=context.resource.name)
    ...
    def user(self):
        ...
        """
        return (
            self.attributes["TRex Controller Shell 2G.User"]
            if "TRex Controller Shell 2G.User" in self.attributes
            else None
        )
    ...
    def user(self, value="admin"):
        ...
        :type value: str
        """
        self.attributes["TRex Controller Shell 2G.User"] = value
    ...
    def password(self):
        ...
        """
        return (
            self.attributes["TRex Controller Shell 2G.Password"]
            if "TRex Controller Shell 2G.Password" in self.attributes
            else None
        )
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes["TRex Controller Shell 2G.Password"] = value
    ...
    def address(self):
        ...
        """
        return (
            self.attributes["TRex Controller Shell 2G.Address"]
            if "TRex Controller Shell 2G.Address" in self.attributes
            else None
        )
    ...
    def address(self, value):
        ...
        :type value: str
        """
        self.attributes["TRex Controller Shell 2G.Address"] = value
    ...
    def client_install_path(self):
        ...
        """
        return (
            self.attributes["TRex Controller Shell 2G.Client Install Path"]
            if "TRex Controller Shell 2G.Client Install Path" in self.attributes
            else None
        )
    ...
    def client_install_path(self, value):
        ...
        :type value: str
        """
        self.attributes["TRex Controller Shell 2G.Client Install Path"] = value
    ...
    def controller_tcp_port(self):
        ...
        """
        return (
            self.attributes["TRex Controller Shell 2G.Controller TCP Port"]
            if "TRex Controller Shell 2G.Controller TCP Port" in self.attributes
            else None
        )
    ...
    def controller_tcp_port(self, value):
        ...
        :type value: str
        """
        self.attributes["TRex Controller Shell 2G.Controller TCP Port"] = value
    ...
    def test_files_location(self):
        ...
        """
        return (
            self.attributes["TRex Controller Shell 2G.Test Files Location"]
            if "TRex Controller Shell 2G.Test Files Location" in self.attributes
            else None
        )
    ...
    def test_files_location(self, value):
        ...
        :type value: str
        """
        self.attributes["TRex Controller Shell 2G.Test Files Location"] = value
